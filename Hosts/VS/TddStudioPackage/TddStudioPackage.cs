...
namespace R4nd0mApps.TddStud10.Hosts.VS
{
    ...
    [ProvideToolWindow(typeof(BuildProgressToolWindow), MultiInstances = false, Style = VsDockStyle.Tabbed,
    ...
    public sealed class ProgressBarPackage : Package, IVsShellPropertyEvents, IVsSolutionEvents, IVsUpdateSolutionEvents2
    {
        ...
        {
            public bool ShowCoverageGlyphs { get { return true; } }

            public event EventHandler<PropertyChangedEventArgs> PropertyChanged;
        
            public  bool ShowLinesColored { get; set; }
        }
        ...
        internal static ProgressBarPackage Instance
        {
            get;
            private set;
        }
